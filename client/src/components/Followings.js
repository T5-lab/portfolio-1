...
function Followings({USER}) {
    ...
    useEffect(() => {
        if(user) {
            axios.get(`${BACKENDURL}/user/followings/${user._id}`, {withCredentials: true})
                .then(res => {
            ...
            <div className='user-info-container'>
                <div className='user-info'>
                    ...
                    <div className='user-info-btns'>
                        ...
                        <Link to={`/user/${id}/followers`}><div className='follow-btn'>Followers</div></Link>
                    </div>
                ...
                <div className='show-details-container'>
                    {followers ? (
                        followers.length ? (
                            ...
                            <h1>this user has no followings</h1>
                        )
                    ) : <Loading/>}
                </div>
            </div>
